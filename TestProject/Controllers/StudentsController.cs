...
namespace TestProject.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StudentName,IdNo,DeptId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StudentName,IdNo,DeptId")] Student student)
        {
            if (ModelState.IsValid)
            {
